...
from feature_engineering import refuting_features, polarity_features, hand_features, bow_averaged_vectors, gen_or_load_feats
...
def generate_features(stances,dataset,name):
    ...
    X_bowv = np.array(gen_or_load_feats(bow_averaged_vectors, h, b, "features/bowvec_200d."+name+".npy"))
    X = np.c_[X_hand, X_polarity, X_refuting, X_overlap, X_bowv]
